...
HB_FUNC(FI_SAVETYPE)
{
  ...
  if (pSave)
  {
    ...
    hb_retl((BOOL)pSave((enum FREE_IMAGE_FORMAT)hb_parni(1), (FIBITMAP *)hb_parnl(2), name,
...
HB_FUNC(FI_RESCALE)
{
  ...
  hb_retnl((pRescale)
               ? (LONG)pRescale((FIBITMAP *)hb_parnl(1), hb_parnl(2), hb_parnl(3), (FREE_IMAGE_FILTER)hb_parni(4))
               : 0);
}
