...
{
  void *hStr;
  hb_retl(ChangeMenu((HMENU)HB_PARHANDLE(1), (UINT)hb_parni(2), HB_PARSTR(3, &hStr, NULL), (UINT)hb_parni(4),
                     (UINT)hb_parni(5)));
  hb_strfree(hStr);
}
...
{
  void *hStr;
  hb_retl(ModifyMenu((HMENU)HB_PARHANDLE(1), (UINT)hb_parni(2), (UINT)hb_parni(3), (UINT)hb_parni(4),
